...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,js,typescript,py,c,cpp,nodejs,docker,mysql,git,github,vscode,vim,bash,figma,pr)](https://skillicons.dev)
